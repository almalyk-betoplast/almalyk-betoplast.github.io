...
export const ui = {
  en: {
    ...
    legal: {
      ...
      heroH1: 'Legal notice',
      heroLead: 'Legal information about the company and this website.',
      companyTitle: 'Company information',
      kName: 'Company name',
      kForm: 'Legal form',
      vForm: 'Joint venture · limited liability company',
      kOffice: 'Registered office',
      kTin: 'TIN',
      contactTitle: 'Contact',
      postalLabel: 'Postal address',
      emailLabel: 'Email',
      websiteLabel: 'Website',
      website: 'ammc-betoplast.com',
      responsibilityTitle: 'Content responsibility',
      responsibilityText: 'Responsible for the editorial content of this website:',
      responsibilityName: 'The Management of Almalyk MMC – Betoplast',
      disclaimerTitle: 'Liability disclaimer',
      disclaimer: [
        'The information provided on this website is for general informational purposes only. While Almalyk MMC – Betoplast makes every effort to ensure that the content is accurate and up to date, we do not guarantee the completeness, reliability or suitability of the information, products or services described herein for any particular purpose.',
        'Any reliance you place on such information is strictly at your own risk. Almalyk MMC – Betoplast shall not be liable for any loss or damage (including indirect or consequential loss) arising from the use of this website or reliance on its content.',
        'This website may contain links to external websites that are not under our control. We have no control over the content, nature or availability of those sites and accept no responsibility for them.',
        'Every effort is made to keep the website operational. However, we accept no liability for temporary unavailability due to technical issues, maintenance or circumstances beyond our reasonable control.',
      ],
      copyrightTitle: 'Copyright & intellectual property',
      copyright: [
        '© 2026 Almalyk MMC – Betoplast. All rights reserved.',
        'All content, texts, images, graphics and other materials on this website are protected by copyright law. Any reproduction, distribution, modification or commercial use without prior written consent is strictly prohibited.',
      ],
      groupNote: 'This website is hosted on GitHub Pages. The company forms part of a wider group; its parent company is BETOPLAST AG (Switzerland).',
  ...
  ru: {
    ...
    legal: {
      ...
      heroH1: 'Правовая информация',
      heroLead: 'Правовая информация о компании и этом сайте.',
      companyTitle: 'Сведения о компании',
      kName: 'Наименование',
      kForm: 'Организационно-правовая форма',
      vForm: 'Совместное предприятие · общество с ограниченной ответственностью',
      kOffice: 'Юридический адрес',
      kTin: 'ИНН',
      contactTitle: 'Контакты',
      postalLabel: 'Почтовый адрес',
      emailLabel: 'Почта',
      websiteLabel: 'Сайт',
      website: 'ammc-betoplast.com',
      responsibilityTitle: 'Ответственность за контент',
      responsibilityText: 'Ответственность за редакционное содержание этого сайта несёт:',
      responsibilityName: 'Руководство Almalyk MMC – Betoplast',
      disclaimerTitle: 'Отказ от ответственности',
      disclaimer: [
        'Информация на этом сайте носит исключительно общий ознакомительный характер. Хотя Almalyk MMC – Betoplast прилагает все усилия для обеспечения точности и актуальности содержимого, мы не гарантируем полноту, надёжность или пригодность представленных сведений, продукции или услуг для какой-либо конкретной цели.',
        'Любое использование этой информации осуществляется исключительно на ваш собственный риск. Almalyk MMC – Betoplast не несёт ответственности за любые убытки или ущерб (включая косвенные или последующие), возникшие в связи с использованием этого сайта или доверием к его содержимому.',
        'Сайт может содержать ссылки на внешние ресурсы, которые не находятся под нашим контролем. Мы не контролируем их содержание, характер и доступность и не несём за них ответственности.',
        'Мы прилагаем усилия для поддержания работоспособности сайта. Тем не менее мы не несём ответственности за временную недоступность по причине технических неполадок, обслуживания или обстоятельств вне нашего разумного контроля.',
      ],
      copyrightTitle: 'Авторские права и интеллектуальная собственность',
      copyright: [
        '© 2026 Almalyk MMC – Betoplast. Все права защищены.',
        'Все материалы, тексты, изображения, графика и прочие элементы этого сайта защищены законодательством об авторском праве. Любое воспроизведение, распространение, изменение или коммерческое использование без предварительного письменного согласия запрещено.',
      ],
      groupNote: 'Сайт размещён на GitHub Pages. Компания входит в более крупную группу; её материнская компания — BETOPLAST AG (Швейцария).',
      privacyTitle: 'Уведомление о защите данных',
      privacyText: 'Сайт не использует отслеживающие cookie. По вопросам обработки персональных данных свяжитесь с нами напрямую.',
    },
  },
  ...
  uz: {
    ...
    legal: {
      navLabel: 'Huquqiy maʼlumot',
      heroEyebrow: 'Huquqiy maʼlumot',
      heroH1: 'Huquqiy maʼlumot',
      heroLead: 'Kompaniya va ushbu sayt haqida huquqiy maʼlumot.',
      companyTitle: 'Kompaniya haqida maʼlumot',
      kName: 'Nomi',
      kForm: 'Tashkiliy-huquqiy shakli',
      vForm: 'Qoʻshma korxona · masʼuliyati cheklangan jamiyat',
      kOffice: 'Yuridik manzil',
      kTin: 'STIR',
      contactTitle: 'Aloqa',
      postalLabel: 'Pochta manzili',
      emailLabel: 'Email',
      websiteLabel: 'Sayt',
      website: 'ammc-betoplast.com',
      responsibilityTitle: 'Kontent uchun masʼuliyat',
      responsibilityText: 'Ushbu saytning tahririy mazmuni uchun masʼul:',
      responsibilityName: 'Almalyk MMC – Betoplast rahbariyati',
      disclaimerTitle: 'Javobgarlikdan voz kechish',
      disclaimer: [
        'Ushbu saytdagi maʼlumotlar faqat umumiy axborot maqsadida berilgan. Almalyk MMC – Betoplast mazmunni aniq va dolzarb saqlashga harakat qilsa-da, biz keltirilgan maʼlumotlar, mahsulotlar yoki xizmatlarning toʻliqligi, ishonchliligi yoki muayyan maqsadga muvofiqligini kafolatlamaymiz.',
        'Ushbu maʼlumotlarga tayanish butunlay sizning oʻz xavfingiz ostida amalga oshiriladi. Almalyk MMC – Betoplast ushbu saytdan foydalanish yoki uning mazmuniga ishonish natijasida yuzaga keladigan har qanday yoʻqotish yoki zarar uchun javobgar emas.',
        'Sayt bizning nazoratimizda boʻlmagan tashqi saytlarga havolalar boʻlishi mumkin. Biz ularning mazmuni, tabiati yoki mavjudligini nazorat qilmaymiz va ular uchun javobgarlikni oʻz zimmamizga olmaymiz.',
        'Biz saytni ishlash holatida saqlashga harakat qilamiz. Shunga qaramay, texnik nosozliklar, texnik xizmat yoki bizning oqilona nazoratimizdan tashqaridagi holatlar tufayli vaqtincha mavjud boʻlmasligi uchun javobgar emasmiz.',
      ],
      copyrightTitle: 'Mualliflik huquqi va intellektual mulk',
      copyright: [
        '© 2026 Almalyk MMC – Betoplast. Barcha huquqlar himoyalangan.',
        'Ushbu saytdagi barcha mazmun, matnlar, tasvirlar, grafikalar va boshqa materiallar mualliflik huquqi toʻgʻrisidagi qonun bilan himoyalangan. Oldindan yozma rozilik olmasdan har qanday koʻpaytirish, tarqatish, oʻzgartirish yoki tijoriy foydalanish taqiqlanadi.',
      ],
      groupNote: 'Ushbu sayt GitHub Pages’da joylashtirilgan. Kompaniya kengroq guruh tarkibiga kiradi; uning bosh kompaniyasi — BETOPLAST AG (Shveytsariya).',
      privacyTitle: 'Maʼlumotlarni himoya qilish boʻyicha eslatma',
      privacyText: 'Sayt kuzatuv cookie-fayllaridan foydalanmaydi. Shaxsiy maʼlumotlarni qayta ishlash tafsilotlari uchun biz bilan toʻgʻridan-toʻgʻri bogʻlaning.',
    },
  },
} as const;
